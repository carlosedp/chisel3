...
abstract class Bundle(implicit compileOptions: CompileOptions) extends Record {
  ...
  /** Implementation of cloneType. This should _never_ be overridden or called in user-code
    *
    * @note This is overridden by the compiler plugin
    */
  @deprecatedOverriding("Users should never override this method", "Chisel 3.4.3")
